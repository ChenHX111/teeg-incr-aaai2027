...
\begin{table}[H]
\centering
\caption{Bench machine A (Intel i7-13700K, $N\!=\!3$ independent
reps on Berlin and NYC 500-OD subsets, $1{,}500$ obs per cell, 1{,}000
...
\midrule
Berlin & HL              & 0.163  & 0.159  & 0.169  & $23.4\times$ \\
Berlin & \textbf{TEEG-ALT-v2}    & \textbf{0.924}  & \textbf{0.908}  & \textbf{0.944}  & $\mathbf{4.13\times}$ \\
Berlin & RAPTOR          & 1.902  & 1.808  & 1.983  & $2.00\times$ \\
Berlin & ULTRA           & 1.935  & 1.866  & 2.020  & $1.97\times$ \\
Berlin & CSA             & 3.812  & 3.696  & 3.902  & $1.00\times$ \\
\midrule
NYC    & HL              & 0.304  & 0.294  & 0.317  & $22.1\times$ \\
NYC    & \textbf{TEEG-ALT-v2}    & \textbf{1.349}  & \textbf{1.316}  & \textbf{1.376}  & $\mathbf{4.98\times}$ \\
NYC    & RAPTOR          & 3.405  & 3.265  & 3.552  & $1.97\times$ \\
NYC    & ULTRA           & 3.466  & 3.280  & 3.666  & $1.94\times$ \\
NYC    & CSA             & 6.718  & 6.603  & 6.830  & $1.00\times$ \\
\bottomrule
\end{tabular}
\end{table}
